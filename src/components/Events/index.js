...
class Events extends Component {
  state = {isActiveStatus: 'INITIAL'}

  onStatusChange = status => {
    this.setState({isActiveStatus: status})
  }

  render() {
    const {isActiveStatus} = this.state
    return (
      <div className="events-background-container">
        ...
        <div className="active-events-container">
          <ActiveEventRegistrationDetails active={isActiveStatus} />
        </div>
      </div>
    )
  }
